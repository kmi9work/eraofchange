...
Player.create(name: "Иван III", human_id: 1, player_type_id: 2, job_id: 1, family_id: 1, params: {"infuence" => 0, "contraband" => []})
Player.create(name: "Борис", human_id: 2, player_type_id: 2, job_id: 2, family_id: 2, params: {"infuence" => 0, "contraband" => []})
Player.create(name: "Манюня", human_id: 3, player_type_id: 2, job_id: 3, family_id: 3, params: {"infuence" => 0, "contraband" => []})
Player.create(name: "Распутин", human_id: 4, player_type_id: 2, job_id: 4, family_id: 4, params: {"infuence" => 0, "contraband" => []})
Player.create(name: "Геронтий", human_id: 5, player_type_id: 2, job_id: 5, family_id: 1, params: {"infuence" => 0, "contraband" => []})
Player.create(name: "Образина", human_id: 6, player_type_id: 2, job_id: 6, family_id: 5, params: {"infuence" => 0, "contraband" => []})
Player.create(name: "Распутин", human_id: 7, player_type_id: 2, job_id: 7, family_id: 6, params: {"infuence" => 0, "contraband" => []})
Player.create(name: "Хренов", human_id: 8, player_type_id: 2, job_id: 8, family_id: 7, params: {"infuence" => 0, "contraband" => []})
Player.create(name: "Даниил", human_id: 9, player_type_id: 2, job_id: 9, family_id: 1, params: {"infuence" => 0, "contraband" => []})
Player.create(name: "Марфа", human_id: 10, player_type_id: 1, family_id: 1, params: {"infuence" => 0, "contraband" => []})
