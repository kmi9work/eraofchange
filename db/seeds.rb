...
Player.create(name: "Даниил", human_id: 9, player_type_id: 2, job_id: 9, family_id: 3, params: {"infuence" => 0}   )
Player.create(name: "Марфа", human_id: 10, player_type_id: 1, job_id: 10, family_id: 3, params: {"infuence" => 0}   )
Player.create(name: "Шимяка", human_id: 11, player_type_id: 1, family_id: 3)
Player.create(name: "Шелом", human_id: 12, player_type_id: 1, family_id: 3)
Player.create(name: "Яромила", human_id: 13, player_type_id: 1, family_id: 3)
Player.create(name: "Булат", human_id: 14, player_type_id: 1, family_id: 3)
Player.create(name: "Богатина", human_id: 15, player_type_id: 1, family_id: 3)
Player.create(name: "Алтын", human_id: 16, player_type_id: 1, family_id: 3)
Player.create(name: "Любава", human_id: 17, player_type_id: 1, family_id: 3)
Player.create(name: "Матрена", human_id: 18, player_type_id: 1, family_id: 3)
...
Resource.create(name: "Доски", identificator: "boards")
Resource.create(name: "Металл", identificator: "metal")
Resource.create(name: "Каменный кирпич", identificator: "stone_brick")
Resource.create(name: "Инструменты", identificator: "tools")
Resource.create(name: "Бревна", identificator: "beam")
Resource.create(name: "Оружие", identificator: "weapon")
Resource.create(name: "Драгоценный металл", identificator: "gems")
Resource.create(name: "Драгоценная руда", identificator: "gem_ore")
Resource.create(name: "Провизия", identificator: "food")
Resource.create(name: "Камень", identificator: "stone")
Resource.create(name: "Mука", identificator: "flour")
Resource.create(name: "Доспехи", identificator: "armor")
Resource.create(name: "Зерно", identificator: "grain")
Resource.create(name: "Лошади", identificator: "horses")
Resource.create(name: "Mясо", identificator: "meat")
Resource.create(name: "Pоскошь", identificator: "luxury")
Resource.create(name: "Железная руда", identificator: "metal_ore")
