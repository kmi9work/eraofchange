...
permian = 8
Country.create(title: "Пермь", id: permian, params: {"relations" => 0, "embargo" => false})
vyatka = 9
Country.create(title: "Вятка", id: vyatka, params: {"relations" => 0, "embargo" => false})
ryazan = 10
Country.create(title: "Рязань", id: ryazan, params: {"relations" => 0, "embargo" => false})
tver = 11
Country.create(title: "Тверь", id: tver, params: {"relations" => 0, "embargo" => false})
novgorod = 12
Country.create(title: "Великий Новгород", id: novgorod, params: {"relations" => 0, "embargo" => false})
