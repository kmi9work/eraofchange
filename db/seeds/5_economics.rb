...
field = 3
PlantType.create(id: field, name: "Зерновые поля", plant_category: dob, fossil_type: fertile_land_fossil)
...
gold_mine = 6
PlantType.create(id: gold_mine, name: "Золотой прииск", plant_category: dob, fossil_type: gem_ore_fossil)
...
PlantLevel.create(level: "3", deposit: "4100", price: {"timber" => 50, "grain" => 200, "tools" => 30},
                  formulas: [{"from" =>         [],
...
PlantLevel.create(level: "1", deposit: "1700", price: {"grain" => 500, "timber" => 100},
                  formulas: [{"from" =>         [],
                            "to" =>           [{"identificator" => "meat", "count" => 60}],
                            "max_product" =>  [{"identificator" => "meat", "count" =>  60}]}],
                  plant_type_id: farm)
...
PlantLevel.create(level: "3", deposit: "10700", price: {"grain" => 1500, "timber" => 200, "tools" => 30},
                  formulas: [{"from" =>         [],
                            "to" =>           [{"identificator" => "meat", "count" => 380}, {"identificator" => "horses", "count" => 55}],
                            "max_product" =>  [{"identificator" => "meat", "count" => 380}, {"identificator" => "horses", "count" => 55}]}],
                  plant_type_id: farm)
...
stonemason = 8
PlantType.create(id: stonemason, name: "Мастерская каменотёса", plant_category: per)
#Мельница
mill = 9
...
tavern = 11
PlantType.create(id: tavern, name: "Житница", plant_category: per)
...
PlantLevel.create(level: "2", deposit: "2500", price: {"boards" => 150, "tools" => 15},
                  formulas: [{"from" =>         [{"identificator" => "grain", "count" => 2}],
                            "to" =>           [{"identificator" => "flour", "count" => 1}],
                            "max_product" =>  [{"identificator" => "flour", "count" => 700}]}],
                  plant_type_id: mill)
...
PlantLevel.create(level: "3", deposit: "9200", price: {"stone_brick" =>400, "food" => 30},
                  formulas: [{"from" =>         [{"identificator" => "gems", "count" => 5}],
                            "to" =>           [{"identificator" => "luxury", "count" => 2}],
                            "max_product" =>  [{"identificator" => "luxury", "count" => 160}]}],
                  plant_type_id: jeweller)
...
PlantLevel.create(level: "3", deposit: "6200", price: {"flour" => 200, "metal" => 50},
                  formulas: [{"from" =>         [{"identificator" => "meat", "count" => 3}, {"identificator" => "flour", "count" => 6}],
                            "to" =>           [{"identificator" => "food", "count" => 2}],
                            "max_product" =>  [{"identificator" => "food", "count" => 240}]}],
                  plant_type_id: tavern)
...
PlantLevel.create(level: "2", deposit: "3400", price: {"boards" => 250, "tools" => 10},
                  formulas: [
                              ...
                              { "from" =>         [{"identificator" => "gem_ore", "count" => 4}],
                                "to" =>           [{"identificator" => "gems", "count" => 1}],
                                "max_product" =>  [{"identificator" => "gems", "count" => 150}]}
                            ],
                  plant_type_id: foundry)
...
PlantLevel.create(level: "3", deposit: "7800", price: {"boards" => 500, "tools" => 35},
                  formulas: [
                              ...
                              { "from" =>         [{"identificator" => "gem_ore", "count" => 3}],
                                "to" =>           [{"identificator" => "gems", "count" => 1}],
                                "max_product" =>  [{"identificator" => "gems", "count" => 300}]}
                            ],
                            plant_type_id: foundry)
...
PlantLevel.create(level: "1", deposit: "1500", price: {"stone_brick" => 50, "metal" => 15},
                  formulas: [
                              { "from" =>         [{"identificator" => "boards", "count" => 1}, {"identificator" => "metal", "count" => 1}],
                                "to" =>           [{"identificator" => "tools", "count" => 1}],
                                "max_product" =>  [{"identificator" => "tools", "count" => 20}]}
                            ],
                  plant_type_id: forge)

PlantLevel.create(level: "2", deposit: "4500", price: {"stone_brick" => 100, "metal" => 30, "tools" => 10},
                  formulas: [
                              { "from" =>         [{"identificator" => "boards", "count" => 1}, {"identificator" => "metal", "count" => 1}],
                                "to" =>           [{"identificator" => "tools", "count" => 1}],
                                "max_product" =>  [{"identificator" => "tools", "count" => 80}]},
                              { "from" =>         [{"identificator" => "boards", "count" => 1}, {"identificator" => "metal", "count" => 2}],
...
PlantLevel.create(level: "3", deposit: "10500", price: {"stone_brick" => 200, "metal" => 60, "tools" => 20},
                  formulas: [
                              { "from" =>         [{"identificator" => "boards", "count" => 1}, {"identificator" => "metal", "count" => 1}],
                                "to" =>           [{"identificator" => "tools", "count" => 1}],
                                "max_product" =>  [{"identificator" => "tools", "count" => 150}]},
                              { "from" =>         [{"identificator" => "boards", "count" => 1}, {"identificator" => "metal", "count" => 2}],
                                "to" =>           [{"identificator" => "weapon", "count" => 1}],
                                "max_product" =>  [{"identificator" => "weapon", "count" => 80}]},
                              { "from" =>         [{"identificator" => "metal", "count" => 4}],
