...
class CreditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit" do
    assert_difference("Credit.count") do
      post credits_url, params: { credit: { deposit: @credit.deposit, duration: @credit.duration, procent: @credit.procent, start_year: @credit.start_year, sum: @credit.sum } }
    end
  ...
  test "should update credit" do
    patch credit_url(@credit), params: { credit: { deposit: @credit.deposit, duration: @credit.duration, procent: @credit.procent, start_year: @credit.start_year, sum: @credit.sum } }
