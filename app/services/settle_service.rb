class SettleService
  ...
  def self.all
    # Задание: Создать новый класс "Экономический субъект" по аналогии
    # с классом "населенный пункт". Придумать самим какие там есть
    # переменные (минимум три) и написать для него метод all.

    #Задание 1*. Сделать так, чтобы выводились населенные пункты только с категорией "town"
