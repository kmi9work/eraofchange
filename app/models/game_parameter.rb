...
def self.register_lingering_effects(action, effect, years = GameParameter.current_year, target = nil)
  ...
  g_p.params ||= []
  g_p.params << {duration: duration, name_of_action: action, effect: effect, target: target}
  g_p.save
end
